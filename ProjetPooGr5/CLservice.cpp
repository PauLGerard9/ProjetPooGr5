...
void NS_Comp_Svc::CLservice::modifierUneCommande(System::String^ id_client, System::String^ txt_colonne_a_changer, System::String^ txt_nouvel_valeur)
{
	System::String^ sql;
	...
	sql = this->oMapp->Update_commande();
